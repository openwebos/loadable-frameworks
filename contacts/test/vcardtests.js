...
/*global _, Address, Birthday, console, Contact, DB, EmailAddress, Future, IMAddress, IMPORTS, include, JSON, MojoTest, Name, Nickname, NULLOBJECT, Organization, Person, PersonFactory, PhoneNumber, Relation, Test, Url, Utils, VCard, VCardExporter, VCardFileReader, VCardImporter */
...
vCardTests.prototype.before = function (done) {
	if (!this.pd) {
...
vCardTests.prototype.after = function (done) {
	var future = DB.del({
		from: Contact.kind
	});
...
vCardTests.prototype.testWriteVCard = function (reportResults) {
	var savedPerson = PersonFactory.createPersonDisplay(this.pd.large_person),
		future,
...
vCardTests.prototype.testWriteAllPersonsVCard = function (reportResults) {
	var savedPersonLarge = PersonFactory.createPersonDisplay(this.pd.large_person),
		savedPersonMedium = PersonFactory.createPersonDisplay(this.pd.medium_person),
		savedPersonSmall = PersonFactory.createPersonDisplay(this.pd.small_person),
		future,
...
vCardTests.prototype.testWriteAllPersonsOnlyPhoneNumbersVCard = function (reportResults) {
	var savedPersonLarge = PersonFactory.createPersonDisplay(this.pd.large_person),
		savedPersonMedium = PersonFactory.createPersonDisplay(this.pd.medium_person),
		savedPersonSmall = PersonFactory.createPersonDisplay(this.pd.small_person),
		future,
...
vCardTests.prototype.testSanitizeCustomLabel = function (reportResults) {
	var failed = false,
		returnedValue,
		valueShouldHaveBeen;
 ...
 * 
 */
vCardTests.prototype.testVCardFileReader = function (reportResults) {
 ...
 * 
 */
vCardTests.prototype.testVCardImporterImportOneVCard = function (reportResults) {
 ...
 * 
 */
vCardTests.prototype.testVCardImporterImportMigVCard = function (reportResults) {
 ...
 * 
 */
vCardTests.prototype.testVCardImporterImportOneGoogleVCard = function (reportResults) {
...
//  * 
//  */
// vCardTests.prototype.testVCardImporterImportOneExchangeVCard = function (reportResults) {
 ...
 * 
 */
vCardTests.prototype.testVCardImporterImportOneVCardThreeContacts = function (reportResults) {
 ...
 * 
 */
vCardTests.prototype.testVCardStatusCallbackWorksSingleContact = function (reportResults) {
	var vCardImporter = new VCardImporter({ filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "vCard3-0.vcf", vCardVersion: VCard.VERSIONS.THREE }),
		testPassed,
 ...
 * 
 */
vCardTests.prototype.testVCardStatusCallbackWorksMultipleContacts = function (reportResults) {
	var vCardImporter = new VCardImporter({ filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "3vCardsInOne.vcf", vCardVersion: VCard.VERSIONS.THREE }),
		testPassed,
		statusCallbackFunction,
 ...
 * 
 */
vCardTests.prototype.testVCardStatusCallbackCancelAfterSecondContact = function (reportResults) {
	var vCardImporter = new VCardImporter({ filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "3vCardsInOne.vcf", vCardVersion: VCard.VERSIONS.THREE }),
		testPassed,
		statusCallbackFunction,
		vCardTestData = _.clone(vCardTests.CONTACTS_FROM_VCARDS.VCards3InOne);
 ...
 * 
 */
vCardTests.prototype.testVCardStatusCallbackWorksMultipleContactsNotSavingToDB = function (reportResults) {
	var vCardImporter = new VCardImporter({ filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "3vCardsInOne.vcf", vCardVersion: VCard.VERSIONS.THREE }),
		testPassed,
		statusCallbackFunction,
		vCardTestData = _.clone(vCardTests.CONTACTS_FROM_VCARDS.VCards3InOne);
...
vCardTests.verifyCorrectVCardEntriesReturned = function (reportResults, vCardContactsToTest, vCardContactsThatShouldExist, testName) {
	...
	if (vCardContactsThatShouldExist.length > 0) {
 ...
 * 
 */
vCardTests.prototype.testVCardImporterHandleLine = function (reportResults) {
	var vCardImporter = this.handle_line_vCard_test_importer;
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLE_LINE_LINES, "NAME", undefined, "SHOULD_RETURN", function (line, multiLineSingleObjectData) {       return vCardImporter._handleLine(line, multiLineSingleObjectData); }, Utils.curry(vCardTests.displayErrorForTest, "_handleLine"), "VALIDATE_FUNCTION", ["LINE", "MULTILINEOBJECTS"])) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 * 
 */
vCardTests.prototype.testVCardImporterCountContacts = function (reportResults) {
 ...
 * 
 */
vCardTests.prototype.testVCardImporterExtractLabel = function (reportResults) {
	...
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.EXTRACTLABEL_LINES, "NAME", "LINE", "SHOULD_RETURN", function (line) { return vCardImporter._extractLabel(line); }, Utils.curry(vCardTests.displayErrorForTest, "_extractLabel"))) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 * 
 */
vCardTests.prototype.testVCardImporterGetLineValue = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
		
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.GETLINEVALUE_LINES, "NAME", "LINE", "SHOULD_RETURN", vCardImporter._getLineValue, Utils.curry(vCardTests.displayErrorForTest, "_getLineValue"))) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 * 
 */
vCardTests.prototype.testVCardImporterGetLinePrefixType = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
		
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.CONTACT_POINT_TYPES_LINES, "NAME", "LINE", "SHOULD_RETURN", vCardImporter._getVCardLinePrefixType, Utils.curry(vCardTests.displayErrorForTest, "_getVCardLinePrefixType"))) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandleEmailLine = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLEEMAIL_LINES, "NAME", "LINE", "SHOULD_RETURN", function (line) { return vCardImporter._handleEmail(line); }, Utils.curry(vCardTests.displayErrorForTest, "_handleEmail"), "VALIDATE_FUNCTION")) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandlePhoneLine = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLEPHONENUMBER_LINES, "NAME", "LINE", "SHOULD_RETURN", function (line) { return vCardImporter._handlePhoneNumber(line); }, Utils.curry(vCardTests.displayErrorForTest, "_handlePhoneNumber"), "VALIDATE_FUNCTION")) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandleNicknameLine = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLENICKNAME_LINES, "NAME", "LINE", "SHOULD_RETURN", function (line) { return vCardImporter._handleNickname(line); }, Utils.curry(vCardTests.displayErrorForTest, "_handleNickname"), "VALIDATE_FUNCTION")) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandleUrl = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLEURL_LINES, "NAME", "LINE", "SHOULD_RETURN", function (line) { return vCardImporter._handleUrl(line); }, Utils.curry(vCardTests.displayErrorForTest, "_handleUrl"), "VALIDATE_FUNCTION")) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandleBirthday = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLEBIRTHDAY_LINES, "NAME", "LINE", "SHOULD_RETURN", function (line) { return vCardImporter._handleBirthday(line); }, Utils.curry(vCardTests.displayErrorForTest, "_handleBirthday"), "VALIDATE_FUNCTION")) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandleName = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLENAME_LINES, "NAME", "LINE", "SHOULD_RETURN", function (line) { return vCardImporter._handleName(line); }, Utils.curry(vCardTests.displayErrorForTest, "_handleName"), "VALIDATE_FUNCTION")) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandleIMAddress = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLEIM_LINES, "NAME", undefined, "SHOULD_RETURN", function (type, line) { return vCardImporter._handleIM(type, line); }, Utils.curry(vCardTests.displayErrorForTest, "_handleIM"), "VALIDATE_FUNCTION", ["TYPE", "LINE"])) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandleCompanyName = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLE_COMPANY_NAME_LINES, "NAME", undefined, "SHOULD_RETURN", function (line, organization) { return vCardImporter._handleCompanyName(line, organization); }, Utils.curry(vCardTests.displayErrorForTest, "_handleCompanyName"), "VALIDATE_FUNCTION", ["LINE", "ORGANIZATION"])) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandleJobTitle = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLE_JOB_TITLE_LINES, "NAME", undefined, "SHOULD_RETURN", function (line, organization) { return vCardImporter._handleJobTitle(line, organization); }, Utils.curry(vCardTests.displayErrorForTest, "_handleJobTitle"), "VALIDATE_FUNCTION", ["LINE", "ORGANIZATION"])) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
 ...
 *
 */
vCardTests.prototype.testVCardImporterHandleAddress = function (reportResults) {
	var vCardImporter = new VCardImporter({filePath: vCardTests.JSUNIT_VCARD_DATA_PATH + "emptyvCard.vcf", vCardVersion: VCard.VERSIONS.THREE});
	
	if (vCardTests.runThisFunctionOnThisObject(vCardTests.HANDLE_ADDRESS_LINES, "NAME", "LINE", "SHOULD_RETURN", function (line) { return vCardImporter._handleAddress(line); }, Utils.curry(vCardTests.displayErrorForTest, "_handleAddress"), "VALIDATE_FUNCTION")) {
		reportResults(MojoTest.passed);
	} else {
		reportResults(MojoTest.failed);
	}
