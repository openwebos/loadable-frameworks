...
/*globals IMPORTS UnitTest console PhoneNumber PhoneFmt */

var webos = IMPORTS.require("webos"); webos.include("test/loadall.js");

function PhoneFormatTestsHK() {
}
...
PhoneFormatTestsHK.prototype.testFormatStyle0 = function() {
	...
	formatted = Globalization.Format.formatPhoneNumber(parsed, "en_hk", "default");
...
PhoneFormatTestsHK.prototype.testFormatStyle0Partial0 = function() {
	...
	formatted = Globalization.Format.formatPhoneNumber(parsed, { locale: "en_hk", partial: true });
